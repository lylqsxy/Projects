...
@Component({
    ...
    template: `
        ...
        <div collapse-on-click #panel="cp" 
            ...
            <i class="md-icon collapsible-indicator" *ngIf="!panel.isCollapsed">arrow_drop_down</i>
            <i class="md-icon collapsible-indicator" *ngIf="panel.isCollapsed">arrow_drop_up</i>
           
            <div class="collapsible-section" *ngIf="!panel.isCollapsed">   
